...
if (isset($_POST['upload'])) {
    $StaffEmail = $_SESSION['StaffEmail']; // Change this to the staff's session variable
    ...
    if ($check === false) {
        ...
        echo "<script>window.location.href='profileStaff.php'</script>"; // Change this to your profileStaff.php page
        $uploadOk = 0;
    }
    ...
    if ($uploadOk == 1) {
        if (move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $targetFile)) {
            ...
            $sql = "UPDATE staff SET ProfilePicture = '$targetFile' WHERE StaffEmail = '$StaffEmail'"; // Change the table and column names
