...
if (isset($_POST['change-password'])) {
    ...
    if ($password !== $re_password) {
        ...
        $update_pass = "UPDATE staff SET code = $code, password = '$hashedPassword', status = '$status' WHERE StaffEmail = '$StaffEmail'";
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form action="newPasswordStaff.php" method="POST" id="forgotpassword-form" autocomplete="off">
