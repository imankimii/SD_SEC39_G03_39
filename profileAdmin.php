...
.btn-pink {
    background-color: pink; /* Sets the background color to pink */
    color: white; /* Sets the text color to white (you can change it if needed) */
    /* You can also add other styles like padding, border, etc., if needed */
}
  </style>
</head>
                  ...
                  <div class="card shadow-sm">
                    ...
                    <div class="center-div">
						<div class="form-group text-center"> 
							<a href="newPasswordAdmin.php" class="btn btn-pink">Change Password</a> 
						</div>
					</div>
                  </div>
                </div>
