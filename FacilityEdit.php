...
<body>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
							...
							while ($row = mysqli_fetch_assoc($result)) {
								...
								echo "<td>" . $row['facilityImage'] . "</td>";
								echo "<td>" . $row['facilityDescription'] . "</td>";
								echo "<td><button class='btn btn-primary EditModalBtnFacility' data-facilityType='$facilityType' data-facilityPrice='{$row['facilityPrice']}' data-facilityAvailable='{$row['facilityAvailable']}' data-facilityImage='{$row['facilityImage']}' data-facilityDescription='{$row['facilityDescription']}'>EDIT</button></td>";
								echo "<td><button class='btn btn-danger deleteButtonFacility' data-facilityType='$facilityType'>DELETE</button></td>";
								echo "</tr>";
							}
							?>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td colspan="7"><button id="AddModalBtnFacility" class='btn btn-success'>ADD</button></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body pt-0">
                        <form method="post" action="EditfunctionFacility.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="facilityImage" name="facilityImage" accept="image/jpeg, image/png, image/jpg" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="facilityDescription">Facility Description</label>
                                <textarea id="facilityDescription" name="facilityDescription" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body pt-0">
                        <form method="post" action="AddfunctionFacility.php">
                            ...
                            <div class="form-group">
                                <label for="facilityImageAdd">Facility Image</label>
                                <input type="file" id="facilityImage" name="facilityImage" accept="image/jpeg, image/png, image/jpg" class="form-control">
                            </div>
                            <div class="form-group">
    ...
    <script>
    // Select all elements with the class "EditModalBtnFacility"
    const editFacilityButtons = document.querySelectorAll(".EditModalBtnFacility");
    ...
    function openFacilityModal(facilityType, facilityPrice, facilityAvailable, facilityImage, facilityDescription) {
        ...
        facilityDescriptionInput.value = facilityDescription;

        // Display the current facility image, checking for an empty facilityImage
        if (facilityImage) {
            facilityImageInput.src = facilityImage;
        } else {
            facilityImageInput.src = "images/DefaultFacility.png"; // Set the default image
        }
    ...
    // Add a click event listener to each edit button for facilities
    ...
    document.getElementById("AddModalBtnFacility").addEventListener("click", function () {
    ...
    const deleteFacilityButtons = document.querySelectorAll(".deleteButtonFacility");
