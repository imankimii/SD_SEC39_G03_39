...
<head>
  ...
  <!-- Custom CSS for Dashboard (Assuming you want to keep this part) -->
                            ...
                            <div class="table-responsive">
								<table class="table text-nowrap">
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo "<td colspan='8'><button class='EditModalBtn' data-id='$id' data-name='{$row['StaffName']}' data-email='{$row['StaffEmail']}' data-gender='{$row['Gender']}' data-race='{$row['Race']}' data-noPhone='{$row['NoPhone']}' data-state='{$row['State']}'>EDIT</button></td>";
								...
								<tfoot>
									<tr>
										<td colspan="8"><button id="AddModalBtn">ADD</button></td>
									</tr>
								</tfoot>
								</table>
							</div>
