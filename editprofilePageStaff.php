...
$StaffName = isset($row['StaffName']) ? $row['StaffName'] : '';
$StaffEmail = isset($row['StaffEmail']) ? $row['StaffEmail'] : '';
...
if (isset($_POST['update_profile'])) {
  ...
  $newStaffName = $_POST['name'];
  $newStaffEmail = $_POST['email'];
  ...
  if (!empty($newStaffName)) {
    $updateStatements[] = "StaffName = '$newStaffName'";
  }
  if (!empty($newStaffEmail)) {
    $updateStatements[] = "StaffEmail = '$newStaffEmail'";
  }
  if (!empty($newGender)) {
  ...
  if (!empty($updateStatements)) {
    ...
    $sql = "UPDATE staff SET " . implode(", ", $updateStatements) . " WHERE StaffEmail = '$StaffEmail'";
    $result = mysqli_query($conn, $sql);

    if ($result) {
      echo "<script>alert('Profile Updated Successfully!')</script>";
      echo "<script>window.location.href='profileStaff.php'</script>";
    } else {
...
<body id="profilepage">
  <div class="ScriptHeader">
    <div class="rt-container>
      ...
      <h1>Profile Page</h1>
      <nav>
        <a href="profileStaff.php" class="menu_item">View Profile</a>
      </nav>
    </div>
  </div>
  <section>
                ...
                <div class="col-lg-4">
                  <div class="card shadow-sm">
                    <div class="profile-image-section">
                      ...
                      <form method="post" action="upload_profile_pictureStaff.php" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <form method="post" action="editProfilePageStaff.php">
                    ...
                    <div class="card-body pt-0">
                      ...
                      <table class="table table-bordered">
						<div class="form-group">
							...
							<input type="text" id="StaffID" name="StaffID" class="form-control" value="<?php echo $StaffID; ?>" readonly>
						</div>
                        <div class="form-group">
